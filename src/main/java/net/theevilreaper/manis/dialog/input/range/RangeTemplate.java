package net.theevilreaper.manis.dialog.input.range;
...
public sealed interface RangeTemplate extends InputTemplate<RangeTemplate> permits RangeTemplateBuilder {
     ...
     * @see net.theevilreaper.manis.dialog.DialogConstants#validateRangeStart
     */
     ...
     * @see net.theevilreaper.manis.dialog.DialogConstants#validateRangeEnd(float)
     */
